...
// Placeholder swarm : à enrichir avec ton algo (PSO, etc.)
void train_swarm(Trainer *trainer, Dataset *dataset) {
    ...
    for (int epoch = 0; epoch < trainer->epochs; epoch++) {
        ...
        for (size_t i = 0; i < max_samples; i++) {
            ...
            // Ici on pourrait ajouter: PSO (Particle Swarm Optimization), algorithmes génétiques, etc.
        }
    }
}